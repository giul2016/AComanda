...
public class SampleSqlLiteFragment extends Fragment implements
		View.OnClickListener {
	public static final String TAG = SampleSqlLiteFragment.class
			.getSimpleName();
...
//		
//		db = new SampleSqlLiteDatabaseHelper(this.getActivity());
//		
